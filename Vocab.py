...
class Vocab_SQUAD:
    ...
    def save(self):
        self.save_dict(self.w_to_i,'SQUAD_Vocab_w_to_i')
        self.save_dict(self.i_to_w,'SQUAD_Vocab_i_to_w')
    def load_dict(self,name):
        with open(name+'.pkl','rb') as f:
            return pickle.load(f)
    def load(self):
        self.w_to_i = self.load_dict('SQUAD_Vocab_w_to_i')
        self.i_to_w = self.load_dict('SQUAD_Vocab_i_to_w')
        self.PAD_ID = self.w_to_i['_PAD_']
        self.UNK_ID = self.w_to_i['_UNK_']
